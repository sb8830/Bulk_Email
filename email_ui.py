...
<ul><li><strong>Google Drive Data and Emails:</strong> All emails and files from existing company domain(*@invesmategroup.com) user accounts have already been migrated to the new Outlook accounts.</li><li><strong>Google Workspace Account Deactivation(@invesmategroup.com):</strong> Your existing company domain(@invesmategroup.com) Gmail accounts will be deactivated on 30Th June, 2025. After this date, you will no longer be able to Open account from Gmail.</li><li><strong>Individual Gmail Account Deactivation(*.invesmategroup@.com in GSUTE):</strong> You will need to move any important files to your company OneDrive as soon as possible. Your G-Sute accounts will be disabled for company use within The mentioned date if anything missing in your one drive.</li></ul>
